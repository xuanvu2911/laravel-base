                ...
                <div class="card-body">
                    <div class="user-avatar-section">
                        <div class="d-flex align-items-center flex-column">
                            <img src="{{ $user->picture == null ? ' /backend/assets/img/avatars/default-avatar.png' : ' /backend/assets/img/avatars/' . $user->picture }}" alt="user-avatar" class="img-fluid rounded my-4  ci-avatar-photo" height="110" width="110" />
                            ...
                            <div class="user-info text-center">
                                ...
                                <div class="button-wrapper">
                                    <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                        <span class="d-none d-sm-block" onclick="event.preventDefault();document.getElementById('user_profile_file').click();">Chọn ảnh thay thế</span>
                                        <i class="bx bx-upload d-block d-sm-none"></i>
                                        <input type="file" name="user_profile_file" id="user_profile_file" class="account-file-input" hidden accept="image/png, image/jpeg" />
                                    </label>
                                    <p class="text-muted mb-0">Chỉ nhận các định dạng ảnh JPG, GIF or PNG.<br>Dung lượng tối đa 800kb</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="nav-align-top mb-4">
              ...
              <div class="tab-content">
                <div class="tab-pane fade show active" id="navs-pills-justified-home" role="tabpanel">
                    <div class="card-body">
                        <form action="<?= route('admin.update-personal-details'); ?>" method="POST" id="personal_details_from" class="fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                            @csrf

                            <div class="row">
                                <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                    <label for="name" class="form-label">Họ và tên </label>
                                    <input class="form-control" type="text" id="name" name="name" value="{{get_user()->name}}" autofocus="">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12 fv-plugins-icon-container">
                                    ...
                                    <textarea name="bio" id="" cols="30" rows="4" class="form-control" placeholder="Nhập một số thông tin giới thiệu ngắn gọn về tài khoản...."><?= get_user()->bio ?></textarea>
                ...
                <div class="tab-pane fade" id="navs-pills-justified-profile" role="tabpanel">
                    <div class="card-body">
                        <form action="<?= route('admin.change-password') ?>" method="POST" id="change_password_form" class="fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                            @csrf
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6 form-password-toggle fv-plugins-icon-container">
                                    ...
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"> <span class="text-danger error-text span-error current_password_error"></span></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-3 col-md-6 form-password-toggle fv-plugins-icon-container">
                                    ...
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"> <span class="text-danger error-text span-error new_password_error"></span></div>
                                </div>
                                ...
                                <div class="mb-3 col-md-6 form-password-toggle fv-plugins-icon-container">
                                    ...
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback "><span class="text-danger error-text span-error confirm_new_password_error"></span></div>
                                </div>
                            </div>
